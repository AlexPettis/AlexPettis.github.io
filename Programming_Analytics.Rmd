...
[Cheat Sheet](Python3-Cheatsheet.pdf)
...
[Multiple Items on a Line](PA4.py)
...
[TermVector](Term Vector.py)

The following text file is the data used to test the program.

[TheTortoiseAndTheHare](TheTortoiseAndTheHare.txt)
...
[Average Year Weater](PA8.ipynb)

The following csv file is the data used.

[Boone Clean](boone_clean.csv)

The following csv file is the results for the year average.

[Average Year](Average_Year.csv)
